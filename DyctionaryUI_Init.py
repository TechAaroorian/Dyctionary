...
class Dy_UserInterfaceInit(Gtk.Window):
    def __init__(self, ):
        ...
        self.Dy_StatusBottomOneText = ["SpeechRecognition not activated yet", "SpeechRecognition activated", "SpeechRecognition has deactivated"]
        self.Dy_StatusBottomTwoText = ["Sleeping", "Listening"]
        self.Dy_StatusBottomThreeText = ["Normal Mode", "Listening Mode", "Dictionary Mode"]
        ###################################################################################################################
        ...
        self.Dy_ScrollWindow.set_policy(Gtk.PolicyType.ALWAYS, Gtk.PolicyType.ALWAYS)
        ...
        self.Dy_SwitchOffButtonI.set_from_file(self.Dy_IconDir + "Switch_off_35.png")
        ...
        self.Dy_SearchButtonI.set_from_file(self.Dy_IconDir + "Search_Icon_35.png")
        ...
        self.Dy_SpeakLButtonI.set_from_file(self.Dy_IconDir + "Speak_Icon_35.png")
        ...
        self.Dy_SpeakMButtonI.set_from_file(self.Dy_IconDir + "SpeakM_Icon_35.png")
        ...
        #self.Dy_VBoxOne.pack_start(self.Dy_MainWindowTitle, True, True, 0)
