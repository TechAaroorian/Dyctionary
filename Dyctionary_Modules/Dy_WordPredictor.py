...
class DyWordPredictor:
    ...
    def DyWordPredictorMain(self, DyWordPredList, DyWordPredWord):
        ...
        for loopOneCurrentElement in self.DyWordPredList:
            self.DyWordPredSmasher = abs((len(loopOneCurrentElement) - len(self.DyWordPredWord) / 100) * 100 - 100)
        ...
        for loopTwoCurrenElement in self.DyWordPredListOne:
            ...
            for loopCurrentPosition in range(self.loopLength):
                if loopTwoCurrenElement[loopCurrentPosition] == self.DyWordPredWord[loopCurrentPosition]:
            ...
            self.DyWordPredPoints[self.DyWordPredPointsNum] = loopTwoCurrenElement
