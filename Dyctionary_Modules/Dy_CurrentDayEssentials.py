...
class currentDayEssentials:
    ...
    def getTimeEssentials(self):
        ...
        currentTime = str(todayTime) + ":" + currentTimeCal[1] + " " + currentMode[0]
        currentTimeSpeech = "Time is, " + str(todayTime) + " " + currentTimeCal[1] + " " + currentMode[1]
        
        todayFullDate = todayMonth + " " + todayDate + " " + todayYear
        todayFullDateSpeech = todayMonth + ", " + todayDate + ", " + todayYear
        
        return [currentTime, currentTimeSpeech, todayFullDate, todayFullDateSpeech, sendRailyWayTime]
